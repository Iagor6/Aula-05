...
public class Principal {
	public static void main(String[] args) {
		...
		System.out.println("O professor: " + aula1.getProfessor().getNome() + ", de CPF: " + takya.getCpf() + ", ministrou a aula de: " + aula1.getConteudo() +", pelo dia " + aula1.getDataAula() + ", na sala " + aula1.getSala().getNumero() + "." ); 
	}
}
